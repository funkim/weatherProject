...
export async function getFutureForcast() {
    try {
        const futureWeather = await fetch('http://api.weatherapi.com/v1/forecast.json?key=51b63f495ebd4f2a82f11004241904&q=Baltimore&days=7&aqi=yes&alerts=yes')
